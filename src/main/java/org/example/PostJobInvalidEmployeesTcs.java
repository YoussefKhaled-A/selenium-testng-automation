...
public class PostJobInvalidEmployeesTcs {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // -------------------- POST JOB PAGE (TC3_InvalidEmployees) --------------------
        ...
        // Expectation: employees = 0 is invalid → we stay on the same post page.
        String url = driver.getCurrentUrl();

        if (url.contains("/employer/job/post")) {
            System.out.println("✅ TC3 Passed: Invalid employees (0) were NOT accepted (still on post page).");
        } else {
            System.out.println("❌ TC3 Failed: Form submitted and navigated away despite invalid employees value.");
        }
